      ...
      <div class="row">
        <div class="col-md-12" style = "float:none;margin:auto">
         ...
         <div class="box box-primary">
            <!-- form start -->
              {!! Form::open(['action' => ['TenantController@store'], 'class' => 'form-horizontal']) !!}
                ...
                <div class="box-body box-form-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="tenantname" id="exampleInputtenantname" placeholder="Enter Tenant Name">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" name = "provisintype" id = "exampleInputprovision" style="width: 100%;">
                        <option selected="selected" value="domain">Domain</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="domain" id="exampleInputDomain" placeholder="Enter Domain">
                  ...
                  <div class = "sliderpart">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        {!! $errors->first('textbuttonslider', '<p class="help-block alert-sm">:message</p>') !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        {!! $errors->first('linksliderbtn', '<p class="help-block alert-sm">:message</p>') !!}
                      </div>
                    </div>
                  </div>
                ...
                <div class="box-body box-form-body">
                  ...
                  <div class="col-sm-10">
                    ...
                    {!! $errors->first('version', '<p class="help-block alert-sm">:message</p>') !!}
                  </div>
                </div>
